...
print("SERVIDOR ON, AGUARDANDO CONEXÃO\n")
...
def SERVIDOR_CriarConta():
    ...
    try:
        ...
        pastaPadroes = ["Documentos", "Imagens", "Músicas", "Atividades", "Etc"]
...
def SERVIDOR_CompartilharConteudo(): # FUNÇÃO COLETA O DICIONARIO {NOME : []}, ONDE A LISTA
